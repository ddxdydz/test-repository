...
if __name__ == "__main__":
    from basic.image.support.IMGArray import IMGArray
    ...
    packed_quantized = quantizer.pack_quantized(quantizer.quantize(original_img.array))
    for _ in range(iterations):
        start_time = time()
        quantized = quantizer.quantize(original_img.array)
    ...
    IMGArray(numpy_array=quantizer.dequantize(quantizer.unpack_quantized(packed_quantized, width, height))).show()
